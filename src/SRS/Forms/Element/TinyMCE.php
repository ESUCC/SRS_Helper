...
/*
 * SRS-1409 Anthony fixed the spell problem
 * 	Commented out the following four lines because we are no longer using NanoSpell as our spellchecker.
 * 	Added the "browser_spellcheck" and "contextmenu" lines to use the TinyMCE built in spellchecker.
 */
...
//					$this->setInlineJsConfig('autoresize_on_init', 'true');
					$this->setInlineJsConfig('images_upload_url', '"upload.php"');
					$this->setInlineJsConfig('relative_urls', 'false');
					$this->setInlineJsConfig('browser_spellcheck', 'true');
					$this->setInlineJsConfig('contextmenu', 'false');
